...
private with Utils.Multicore;
private with Interfaces;
package Interrupt_Handling is
...
private
   ...
   end record with Alignment => Utils.Cache_Line_Size_In_Bytes;
   ...
   Cpu_To_Interrupt_Nesting :
      array (Utils.Multicore.Cpu_Core_Id_Type) of Interrupt_Nesting_Type;
