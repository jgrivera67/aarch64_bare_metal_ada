...
alias alr_build_rpi4_sd_boot='alr build -- -XBoard=rpi4 -XUart_Boot=no'
alias alr_clean_rpi4_sd_boot='alr clean -- -XBoard=rpi4 -XUart_Boot=no'
alias alr_build_rpi5_sd_boot='alr build -- -XBoard=rpi5 -XUart_Boot=no'
alias alr_clean_rpi5_sd_boot='alr clean -- -XBoard=rpi5 -XUart_Boot=no'
alias alr_build_rpi4_uart_boot='alr build -- -XBoard=rpi4 -XUart_Boot=yes'
alias alr_clean_rpi4_uart_boot='alr clean -- -XBoard=rpi4 -XUart_Boot=yes'
alias alr_build_rpi5_uart_boot='alr build -- -XBoard=rpi5 -XUart_Boot=yes'
alias alr_clean_rpi5_uart_boot='alr clean -- -XBoard=rpi5 -XUart_Boot=yes'
